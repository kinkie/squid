                           ...
                           StoreIOState::STIOCB *aCallback, void *callback_data)
{
    ...
    debugs(79, 3, HERE << "fileno " << std::setfill('0') << std::hex << std::uppercase << std::setw(8) << e->swap_filen);
                             ...
                             StoreIOState::STIOCB *aCallback, void *callback_data)
{
    ...
    debugs(79, 3, HERE << "fileno " << std::setfill('0') << std::hex << std::uppercase << std::setw(8) << filn);
