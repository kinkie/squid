...
#include "mgr/Action.h"
    ...
    bool Mgr::Action::atomic() const STUB_RETVAL(false)
        const char *Mgr::Action::name() const STUB_RETVAL(NULL) static Mgr::Command static_Command;
const Mgr::Command &Mgr::Action::command() const STUB_RETVAL(static_Command)
    StoreEntry *Mgr::Action::createStoreEntry() const STUB_RETVAL(NULL) static Mgr::Action::Pointer dummyAction;
...
Mgr::ActionParams::ActionParams() STUB_NOP
    ...
    std::ostream &
    operator<<(std::ostream &os, const Mgr::ActionParams &params) STUB_RETVAL(os)
...
#include "mgr/BasicActions.h"
    Mgr::Action::Pointer Mgr::MenuAction::Create(const Mgr::CommandPointer &cmd) STUB_RETVAL(dummyAction) void Mgr::MenuAction::dump(StoreEntry *entry) STUB
    //protected:
    //Mgr::MenuAction::MenuAction(const CommandPointer &cmd) STUB

    Mgr::Action::Pointer Mgr::ShutdownAction::Create(const Mgr::CommandPointer &cmd) STUB_RETVAL(dummyAction) void Mgr::ShutdownAction::dump(StoreEntry *entry) STUB
    // protected:
    //Mgr::ShutdownAction::ShutdownAction(const CommandPointer &cmd) STUB

    Mgr::Action::Pointer Mgr::ReconfigureAction::Create(const Mgr::CommandPointer &cmd) STUB_RETVAL(dummyAction) void Mgr::ReconfigureAction::dump(StoreEntry *entry) STUB
    //protected:
    //Mgr::ReconfigureAction::ReconfigureAction(const CommandPointer &cmd) STUB

    Mgr::Action::Pointer Mgr::RotateAction::Create(const Mgr::CommandPointer &cmd) STUB_RETVAL(dummyAction) void Mgr::RotateAction::dump(StoreEntry *entry) STUB
    //protected:
    //Mgr::RotateAction::RotateAction(const CommandPointer &cmd) STUB

    Mgr::Action::Pointer Mgr::OfflineToggleAction::Create(const CommandPointer &cmd) STUB_RETVAL(dummyAction) void Mgr::OfflineToggleAction::dump(StoreEntry *entry) STUB
    //protected:
...
#include "mgr/CountersAction.h"
    ...
    Mgr::CountersActionData &Mgr::CountersActionData::operator+=(const Mgr::CountersActionData &stats) STUB_RETVAL(*this)
        ...
        Mgr::Action::Pointer Mgr::CountersAction::Create(const CommandPointer &cmd) STUB_RETVAL(dummyAction) void Mgr::CountersAction::add(const Action &action) STUB
...
#include "mgr/FunAction.h"
    Mgr::Action::Pointer Mgr::FunAction::Create(const CommandPointer &cmd, OBJH *aHandler) STUB_RETVAL(dummyAction) void Mgr::FunAction::respond(const Request &request) STUB
    //protected:
...
#include "mgr/InfoAction.h"
    ...
    Mgr::InfoActionData &Mgr::InfoActionData::operator+=(const Mgr::InfoActionData &stats) STUB_RETVAL(*this)
        ...
        Mgr::Action::Pointer Mgr::InfoAction::Create(const CommandPointer &cmd) STUB_RETVAL(dummyAction) void Mgr::InfoAction::add(const Action &action) STUB
...
#include "mgr/Inquirer.h"
    ...
    bool Mgr::Inquirer::doneAll() const STUB_RETVAL(false) void Mgr::Inquirer::cleanup() STUB
...
#include "mgr/IoAction.h"
    ...
    Mgr::IoActionData &Mgr::IoActionData::operator+=(const IoActionData &stats) STUB_RETVAL(*this)
        ...
        Mgr::Action::Pointer Mgr::IoAction::Create(const CommandPointer &cmd) STUB_RETVAL(dummyAction) void Mgr::IoAction::add(const Action &action) STUB
...
#include "mgr/QueryParams.h"
    Mgr::QueryParam::Pointer Mgr::QueryParams::get(const String &name) const STUB_RETVAL(Mgr::QueryParam::Pointer(NULL)) void Mgr::QueryParams::pack(Ipc::TypedMsgHdr &msg) const STUB
    ...
    Mgr::QueryParam::Pointer Mgr::QueryParams::CreateParam(QueryParam::Type aType) STUB_RETVAL(Mgr::QueryParam::Pointer(NULL)) bool Mgr::QueryParams::ParseParam(const String &paramStr, Param &param) STUB_RETVAL(false)
...
Ipc::Response::Pointer Mgr::Response::clone() const STUB_RETVAL(Ipc::Response::Pointer(NULL)) bool Mgr::Response::hasAction() const STUB_RETVAL(false)
...
#include "mgr/ServiceTimesAction.h"
    ...
    Mgr::ServiceTimesActionData &Mgr::ServiceTimesActionData::operator+=(const Mgr::ServiceTimesActionData &stats) STUB_RETVAL(*this)
        ...
        Mgr::Action::Pointer Mgr::ServiceTimesAction::Create(const Mgr::CommandPointer &cmd) STUB_RETVAL(Mgr::Action::Pointer(NULL)) void Mgr::ServiceTimesAction::add(const Action &action) STUB
...
#include "mgr/StoreIoAction.h"
    ...
    Mgr::Action::Pointer Mgr::StoreIoAction::Create(const CommandPointer &cmd) STUB_RETVAL(Mgr::Action::Pointer(NULL)) void Mgr::StoreIoAction::add(const Action &action) STUB
...
#include "mgr/StoreToCommWriter.h"
    ...
    bool Mgr::StoreToCommWriter::doneAll() const STUB_RETVAL(false) void Mgr::StoreToCommWriter::scheduleStoreCopy() STUB
...
#include "mgr/StringParam.h"
    ...
    static String t;
const String &
Mgr::StringParam::value() const STUB_RETVAL(t)
