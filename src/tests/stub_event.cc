...
void
eventAdd(const char *name, EVH *func, void *arg, double when, int, bool cbdata) STUB_NOP
    ...
    int EventScheduler::timeRemaining() const STUB_RETVAL(1) void EventScheduler::clean() STUB
    void EventScheduler::dump(StoreEntry *) STUB
    bool EventScheduler::find(EVH *func, void *arg) STUB_RETVAL(false) void EventScheduler::schedule(const char *name, EVH *func, void *arg, double when, int weight, bool cbdata) STUB
