...
Comm::AcceptLimiter &Comm::AcceptLimiter::Instance() STUB_RETVAL(dummy) void Comm::AcceptLimiter::defer(const Comm::TcpAcceptor::Pointer &afd) STUB
...
#include "comm/Connection.h"
    ...
    Comm::Connection::~Connection() STUB
    Comm::ConnectionPointer Comm::Connection::copyDetails() const STUB_RETVAL(NULL) void Comm::Connection::close() STUB
    CachePeer *Comm::Connection::getPeer() const STUB_RETVAL(NULL) void Comm::Connection::setPeer(CachePeer *p) STUB
...
bool Comm::ConnOpener::doneAll() const STUB_RETVAL(false) void Comm::ConnOpener::start() STUB
    void Comm::ConnOpener::swanSong() STUB
    Comm::ConnOpener::ConnOpener(Comm::ConnectionPointer &, const AsyncCall::Pointer &, time_t) :
    AsyncJob("STUB Comm::ConnOpener") STUB
...
#include "comm/Loops.h"
    ...
    Comm::Flag Comm::DoSelect(int) STUB_RETVAL(Comm::COMM_ERROR) void Comm::QuickPollRequired(void) STUB
...
#include "comm/Read.h"
    ...
    bool Comm::MonitorsRead(int fd) STUB_RETVAL(false)
        Comm::Flag Comm::ReadNow(CommIoCbParams &params, SBuf &buf) STUB_RETVAL(Comm::COMM_ERROR) void Comm::ReadCancel(int fd, AsyncCall::Pointer &callback) STUB
...
#include "comm/Write.h"
    ...
    std::ostream &
    operator<<(std::ostream &os, const Comm::Connection &conn) STUB_RETVAL(os << "[Connection object]")
