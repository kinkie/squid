...
inline const char *
ErrorString(const ErrorCode code)
{
#if USE_OPENSSL
...
#if USE_OPENSSL
CtoCpp1(EVP_PKEY_free, EVP_PKEY *) typedef Security::LockingPointer<EVP_PKEY, EVP_PKEY_free_cpp, HardFun<int, EVP_PKEY *, EVP_PKEY_up_ref>> PrivateKeyPointer;
#elif USE_GNUTLS
