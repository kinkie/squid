...
namespace Icap {
    ...
    public:
        ...
        {
            assert(sawUseOriginalBody());
            return static_cast<uint64_t>(useOriginalBody_);
        }
        ...
        public:
            ...
            bool doneConsumingVirgin() const
            {
                return writing >= writingAlmostDone
                    && ((sending == sendingAdapted && !readyForUob) || sending == sendingDone);
            }
            ...
            {
                return parsing == psIcapHeader || parsing == psHttpHeader;
            }

            enum Parsing { psIcapHeader,
                           psHttpHeader,
                           psBody,
                           psIcapTrailer,
                           psDone } parsing;
