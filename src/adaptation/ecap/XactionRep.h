...
namespace Ecap {
   ...
   eCAP xactions. */
    class XactionRep : public Adaptation::Initiate, public libecap::host::Xaction, public BodyConsumer, public BodyProducer
    {
    ...
    private:
        ...
        typedef enum { opUndecided,
                       opOn,
                       opComplete,
                       opNever } OperationState;
